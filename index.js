...
// const store =new mongodbSession({uri: process.env.MONGO_URI, collection :"sessions"});
...
// app.use(session({           // middleware defined for session based auth
...
//             }
//             if (!userDb) return res.status(400).json("user not found, please register first");
...
//         }
//         catch (error) { return res.status(500).json(console.error());}
//     //seesion based auth
// });
